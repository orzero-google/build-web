...
$configuration['db']	= 'tianya20100108';		//	<- database name
$configuration['host'] 	= 'tianya20100108.db.4667417.hostedresource.com';	//	<- database host
$configuration['user'] 	= 'tianya20100108';		//	<- database user
$configuration['pass']	= 'aa55@@TY';		//	<- database password
...
//程序根目录
$set['root'] = '/home/content/17/4667417/html/read';
