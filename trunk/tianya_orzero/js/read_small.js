...
//$(document).ready(function(){
    ...
    if(binfo=="") {binfo="OT"}		//other 没有检查到的浏览器类型
  ...
  $("div.blog span.open").each(function () {}).css("cursor", "pointer").click(function (){
  	...
  	$("div.section h4").each(function () {
  		...
  		if(the_name == name){
  			var ui_st = $(this).find("div.tools span");
				ui_st.removeClass();
				ui_st.addClass('ui-icon ui-icon-circle-minus');
  			//alert(ui_st.html());  			
