...
<div id="content">
	...
	<div class="grid-16-8 clearfix">
		...
		<?php if($channel == 'index'){ ?>
			...
			<div style="float:right;color:#CCCCCC;">&nbsp;/&nbsp;<a href="http://read.orzero.com/" target="_blank" title="或零网络"><span>[整理新帖]</span></a></div>
		<?php }else{ ?>
...
?>
					<tr>
						...
						<a href="http://read.orzero.com/index.php?url=<?php echo $td['url']; ?>" target="_blank" title="或零网络"><span>[更新]</span></a>
						<div class="info">
...
/* 468x60, 创建于 09-8-16, search eng */
google_ad_slot = "5307823467";
google_ad_width = 468;
google_ad_height = 60;
//-->
</script>
