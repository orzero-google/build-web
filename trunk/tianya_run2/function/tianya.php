...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://read.orzero.com/chartapi.css" />
...
function get_header($p_info, $p_content, $tid){
	...
	$keywords = '或零,orzero,read.orzero.com,或零网络,或零阅读,'.$p_info->title.',第'.$tid.'页,'.$p_info->channel_cn
	.','.$p_info->channel_en.','.$p_info->author_name.','.',或零易读,或零阅读,或零小说,或零在线';
	$hd = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	<title>或零,ORZERO,或零网络::或零阅读,'.$p_info->title.',[第'.$tid.'页],http://read.orzero.com</title>
	<meta name="author" content="'.$p_info->author_name.'" />
	<meta name="keywords" content="'.$keywords.'" />
	<meta name="description" content="或零易读,或零阅读,或零小说,或零在线,'.$p_info->title.','.$list.'" />
	<link type="text/css" href="http://read.orzero.com/css/start/jquery-ui-1.7.2.custom.css" rel="stylesheet" />	
	<link type="text/css" href="http://read.orzero.com/css/read.css" rel="stylesheet" />
...
<!--
	...
	<script type="text/javascript" src="js/jquery-ui-1.7.2.custom.min.js"></script>
-->
	<script type="text/javascript" src="http://read.orzero.com/js/read.min.js"></script>
</head>
<body>
...
<table>
	<thead style="font-size:14px;">
		...
		<tr><td class="new"><span style="float:left;" class="ui-icon ui-icon-heart"></span>
		<a title="整理新帖子" target="_blank" href="http://read.orzero.com/"><span style="text-align:center;font-size:12px;text-decoration:underline;color:#666666;">整理新帖</span></a>
		</td></tr>
	</thead>
</table>
</div>
...
for($i=1; $i<=$page_count; $i++){
	...
	$ft .= "\t".'<a class="jump" pid="'.$i.'" title="或零整理帖子" href="http://read.orzero.com/read/orzero-'.$tid.'/page-'.$i.'.html"><span '.$style.'>第'.$i.'页('.$posts_list[$i].')</span></a>'."\n";
}
$ft .= '
</div>
