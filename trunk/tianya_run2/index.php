...
<style type="text/css">
#gbar{margin-top: 4px;float:top;}.gb1, .gb3{height: 22px;margin-right: 0.43em;vertical-align: top;font-size:13px;}a.gb1, a.gb2, a.gb3{color: #0000cc;}a{text-decoration:none;}a:hover{color: #ffffff;background-color: #3080cb;background-image: none;background-repeat: repeat;background-attachment: scroll;background-position: 0% 0%;}
</style>
</head>
<body>
<div id="gbar">
	<nobr>
		...
		<a href="http://read.orzero.com/list/orzero-all.html" onclick="gbar.qs(this);" class="gb1">或零读书</a>
		...
		<a href="http://read.orzero.com/list/orzero-index.html" onclick="gbar.qs(this);" class="gb1">官方网</a>
		...
		<a href="http://www.orzero.com" onclick="this.blur();gbar.tg(event);return !1" aria-haspopup="true" class="gb3">
			<u style="height:22px;vertical-align:top;">杂文</u><small style="text-decoration:none;">▼</small></a>
